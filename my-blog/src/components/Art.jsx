        ...
        <div className="mb-16">
          ...
          <ul className="space-y-4 text-lg list-disc pl-6 text-gray-700">
            <li>Jason starring in Blockchain Reality Show Angels Villa. View trailer: 
              <a href="https://www.instagram.com/reel/C-g4WToy6IJ/?igsh=MTBrZ296Z3RwODl0bg==" className="text-blue-600 hover:text-blue-800 ml-1">Instagram Video</a>
            </li>
